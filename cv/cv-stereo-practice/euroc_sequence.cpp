...
namespace unicorn {
    ...
    euroc_sequence::euroc_sequence(const std::string& seq_dir_path) {
        ...
        const std::string timestamp_file_path = seq_path + "/cam0/data.csv";
        const std::string left_img_dir_path = seq_path + "/cam0/data/";
        const std::string right_img_dir_path = seq_path + "/cam1/data/";
